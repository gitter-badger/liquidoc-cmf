...
This repo contains the boilerplate files for, and rudimentary documentation of, a content management framework (CMF) for combining open-source tools and workflows for documentation management.
