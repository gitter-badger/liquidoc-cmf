...
----
+
This procedure builds starter files (and inflates directories), including a new `README.adoc` and `content/index.adoc`.

You should now have a `_configs/` directory containing LiquiDoc, Asciidoctor, and Jekyll config files.
If your initialization steps proceeded without errors, you should have a successful rudimentary LDCMF codebase.
